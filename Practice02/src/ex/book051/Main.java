...
import static ex.book051.User.getBuilder;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		User user2 = getBuilder("ionk", "44fef22").email("ion@gmail.com").build();
		...
		User user3 = getBuilder("monika", "klooi0988").email("monika@gmail.com").firstName("Monika").lastName("Ghuenter").build();
