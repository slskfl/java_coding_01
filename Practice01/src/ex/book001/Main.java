...
public class Main {
	...
	private static final String TEXT = "Be strong, be fearless, be beautiful. " + "And believe that anything is possible when you have the right " + "people there to support you. ";
	...
	public static void main(String[] args) {
		...
		System.out.println(duplicatesV2);
